...
* **Migration scope**: Charts, transformations, Kusto/SQL comparisons, HTML preview bridges, Kusto model/tool result responses, and Share Results use immutable bindings or exact provenance. Save/copy CSV and other row exports still lack dedicated artifact policy; migrate them one at a time with a discriminating pin/rebind/clear test rather than bypassing the facade.
