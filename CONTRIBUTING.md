...
* **Deferred artifacts**: Do not treat mutable `results-state.ts` entries as immutable lineage. Immutable artifact revisions and downstream producer bindings belong to EXA-2.
