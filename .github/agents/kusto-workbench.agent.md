---
name: Kusto Workbench Agent
description: Use Kusto Workbench to write and execute KQL queries, analyze data, and create visualizations
tools:
  - kusto-workbench_list-connections
  - kusto-workbench_list-favorites
  - kusto-workbench_list-schemas
  - kusto-workbench_list-sections
