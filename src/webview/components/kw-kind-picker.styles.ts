...
export const styles = css`
	...
	.type-selector { display: inline-flex; gap: 2px; padding: 6px 8px; flex-shrink: 0; background: var(--vscode-toolbar-hoverBackground, rgba(128, 128, 128, 0.1)); border-radius: 4px; }
	.type-selector-btn { display: inline-flex; align-items: center; gap: 7px; padding: 5px 14px; font-size: 12px; font-weight: 500; border: none; border-radius: 3px; background: transparent; color: var(--vscode-descriptionForeground); cursor: pointer; font-family: inherit; white-space: nowrap; transition: all 0.18s ease; letter-spacing: 0.01em; }
