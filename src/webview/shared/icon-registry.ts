...
export const ICONS = {
	...
	copy: codicon('copy'),
	refresh: svg(html`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M13 4v4H9"/><path d="M12.2 8A4.7 4.7 0 0 0 4 4.7"/><path d="M3 12V8h4"/><path d="M3.8 8A4.7 4.7 0 0 0 12 11.3"/></svg>`),
	...
	close: svg(html`<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" xmlns="http://www.w3.org/2000/svg"><path d="M4 4l8 8M12 4l-8 8"/></svg>`),
