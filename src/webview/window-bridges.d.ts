...
declare global {
	interface Window {
		...
		__kustoAutoTriggerAutocompleteEnabledUserSet: (enabled?: boolean) => boolean | undefined;
		__kustoCaretDocsEnabledUserSet: (enabled?: boolean) => boolean | undefined;
		...
		// =====================================================================
		__kustoNormalizeCellForComparison?: (cell: any) => unknown[];
