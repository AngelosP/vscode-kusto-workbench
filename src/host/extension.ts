	...
	context.subscriptions.push(
		vscode.commands.registerCommand('kusto.manageConnections', afterFirstLaunch(() => {
			ConnectionManagerViewerV2.open(context, context.extensionUri, connectionManager, {
				...
				tryDispatchSqlOwnerSnapshot: dispatch => sqlWorkbenchService!.tryDispatchSqlOwnerSnapshot(dispatch),
				retrySqlOwnerSnapshotAcquisition: attempt => sqlWorkbenchService!.retrySqlOwnerSnapshotAcquisition(attempt),
