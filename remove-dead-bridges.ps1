...
$removals = @{
    ...
    'sections/kw-query-toolbar.ts' = @('updateCopilotInlineCompletionsToggleButtons','closeToolsDropdown','toggleOverflowSubmenu','closeToolbarOverflow','getRunModeLabelText','closeRunMenu')
