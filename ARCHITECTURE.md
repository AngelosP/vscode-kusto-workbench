...
Table-local copy and any other unmigrated row consumers still require an EXA-2 closure audit. This slice does not persist transformation payloads, merge the Kusto and SQL execution coordinators, or introduce deferred document capability admission.
