...
| `queryEditorProviderCopilotQueryWorkflowHandler.test.ts` | Red-first real-provider five-route reference-identical forwarding, deferred settlement, exact rejection, zero direct Copilot/preflight/token/transport effects, current 15-case provider inventory, and disposal ownership |
...
| `queryEditorProviderKustoSectionExecutionHandler.test.ts` | Red-first real-provider seven-route reference-identical forwarding, deferred settlement, exact rejection, zero direct coordinator/client/selection/transport/acknowledgement/Copilot-close effects, 15-case inventory, and disposal ownership |
...
| `queryEditorProviderComparisonPreparationHandler.test.ts` | Red-first real-provider three-route and preparation forwarding, deferred settlement, exact rejection, zero direct map/lifecycle/broker/coordinator/Copilot effects, 15-case inventory, and disposal ownership |
