Feature: Did you know embedded file popup
  ...
  Scenario: File-open compact popup appears inside the Kusto editor webview
    When I open file "tests/vscode-extension-tester/e2e/default/did-you-know-embedded-popup/fixtures/embedded-did-you-know.kqlx" in the editor
    And I wait for "kw-query-section .monaco-editor" in the webview for 25 seconds
    And I execute command "kustoWorkbench.test.resetDidYouKnowState" with args '[{"openIfKustoFileOpen":true,"silent":true}]'
