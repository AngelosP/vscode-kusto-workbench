Feature: Persisted query results restore
  ...
  Scenario: Open and reopen a KQLX file with persisted results
    ...
    And I wait 1 second
    When I execute command "kustoWorkbench.test.preparePersistedResultFixture" with args '[{"engine":"kusto","templatePath":"tests/vscode-extension-tester/e2e/default/persisted-results-restore/fixtures/persisted-results.kqlx","outputPath":"tests/vscode-extension-tester/runs/default/persisted-results-restore/owned-results.kqlx"}]'
    And I wait 1 second
    When I open file "tests/vscode-extension-tester/runs/default/persisted-results-restore/owned-results.kqlx" in the editor
    And I wait 6 seconds
    When I wait for "#queries-container" in the webview "owned-results.kqlx" for 20 seconds
    When I evaluate "window.__e2e.workbench.waitForPersistedResult('query_persisted_results', 19000)" in the webview "owned-results.kqlx" for 20 seconds
