Feature: Mixed .kqlx document restore
  ...
  Scenario: Save and reopen a mixed document
    ...
    When I scroll "kw-html-section" into view in the webview "workfile.kqlx"
    And I wait 1 second
    When I execute command "workbench.action.focusActiveEditorGroup"
    And I move the mouse to 30, 700
    And I click
    ...
    When I scroll "kw-sql-section" into view in the webview "workfile.kqlx"
    And I wait 1 second
    When I execute command "workbench.action.focusActiveEditorGroup"
    And I move the mouse to 30, 700
    And I click
