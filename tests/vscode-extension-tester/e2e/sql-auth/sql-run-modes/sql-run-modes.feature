Feature: SQL run modes — split button, plain vs TOP 100
  ...
  Scenario: Run mode defaults to TOP 100, can switch modes, label updates
    # ── Setup ─────────────────────────────────────────────────────────────
    ...
    # ── TEST 1: Default mode is TOP 100 ──────────────────────────────────
    ...
    # ── TEST 2: Split button dropdown exists ──────────────────────────────
    ...
    # ── TEST 3: Switch to plain mode (via setRunMode to avoid auto-execute)
    ...
    # ── TEST 4: Switch back to top100 mode ────────────────────────────────
    ...
    # ── TEST 5: Run mode included in serialization ────────────────────────
